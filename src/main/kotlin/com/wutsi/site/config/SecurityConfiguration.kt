    ...
    public companion object {
        public val SECURED_ENDPOINTS: RequestMatcher =
            org.springframework.security.web.util.matcher.OrRequestMatcher(
                org.springframework.security.web.util.matcher.AntPathRequestMatcher("/v1/sites/*", "GET"),
                org.springframework.security.web.util.matcher.AntPathRequestMatcher("/v1/sites/*", "POST"),
                org.springframework.security.web.util.matcher.AntPathRequestMatcher("/v1/sites/*/attributes/*", "POST"),
                org.springframework.security.web.util.matcher.AntPathRequestMatcher("/v1/sites", "GET"),
                org.springframework.security.web.util.matcher.AntPathRequestMatcher("/v1/sites", "POST")
            )
    }
